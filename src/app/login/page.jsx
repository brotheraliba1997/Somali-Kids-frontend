    ...
    const handleChange = (e) => {
      ...
      const submitHandler = async (e) => {
        ...
        //   notifySuccess("Logged in successfully!");
          ...
          //   accessTokenExpiry: data.tokens.access.expiresAt,
          //   refreshToken: data.tokens.refresh.token,
          //   refreshTokenExpiry: data.tokens.refresh.expiresAt,
          //   redirect: true,
  ...
  <div className="login-box">
    ...
    <div className="card card-navy my-2">
      <div className="card-body">
        ...
        <form id="login-frm" action="" method="post" onSubmit={submitHandler}>
