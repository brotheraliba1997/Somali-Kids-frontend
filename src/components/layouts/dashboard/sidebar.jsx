...
function Sidebar() {
  ...
  <a href="index.html" className="brand-link bg-navy text-sm ">
    ...
    />
    <span className="brand-text font-weight-light text-light">Somali ABC</span>
  </a>
        ...
        >
          ...
          <nav className="mt-1">
            ...
            >
              ...
              <li className="nav-item dropdown">
                <Link href="/dashboard/customer-registration" className="nav-link nav-customer">
              ...
              <li className="nav-item dropdown">
                <Link href="/dashboard/users" className="nav-link nav-user_list">
              ...
              <li className="nav-item">
                ...
                <ul className="nav nav-treeview" style={{ display: "none" }}>
                  <li className="nav-item">
                    <a href="#" className="nav-link tree-item nav-categories">
                      <i className="far fa-circle nav-icon" />
                      <p>Categories</p>
                    </a>
                  </li>
                  <li className="nav-item">
                    <a href="#" className="nav-link tree-item nav-languages">
                      <i className="far fa-circle nav-icon" />
                      <p>Languages</p>
                    </a>
                  </li>
